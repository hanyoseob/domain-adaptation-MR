...
if opts.enableGpu
  ...
  switch arch
    ...
    case 'win32', opts.cudaLibDir = fullfile(opts.cudaRoot, 'lib', 'x86') ;
  ...
  if strcmp(arch, 'win32') && isempty(opts.cudaMethod)
    opts.cudaMethod = 'nvcc';
  end
...
if opts.enableCudnn
  ...
  switch arch
    ...
    case 'win32', opts.cudnnLibDir = fullfile(opts.cudnnRoot, 'lib', 'x86') ;
